...
import com.gwu.cs6431.service.messageHandler.RspAbstractHandler;
...
public class Task implements Runnable {
    ...
    private void handle(Message msg) {
        ...
        RspAbstractHandler rspHandler = new RspAbstractHandler(socket, msg.getSourceUser(), msg.getTargetUser());
        if (accepted) {
